...
const IconMap: React.FC<IconProps> = ({ type, className = "w-12 h-12" }) => {
  switch (type) {
    case 'lightbulb':
      return (
    ...
    case 'shield':
      return (
        <svg className={`${className} text-pink-400`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    case 'globe':
      return (
        <svg className={`${className} text-cyan-400`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
